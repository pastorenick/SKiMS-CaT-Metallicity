#!/usr/bin/env python
# Filename: CaTindexMeasurement_modG2.py
# Retrieve the CaT index from SKiMS new output (pickle files)
# requires CaTscript_v3.py, CaTindexMeasurement_def.py
# IT IS OPTIMIZED FOR G2
...
from CaTindexMeasurement_def import *
...
from galaxyParametersDictionary_v4 import *
